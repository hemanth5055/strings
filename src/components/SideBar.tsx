    ...
    <div className="w-full flex flex-col gap-3  ">
      ...
      <Link className="w-full flex items-center gap-2" href="/">
        <div className="w-[40px] h-[40px] flex justify-center items-center">
          <FiHome size={20}></FiHome>
        </div>
        <h3 className="font-semibold leading-[-0.005%] text-[#F3F5F7]">Home</h3>
      </Link>
      {/* search */}
      <Link className="w-full flex items-center gap-2" href="/search">
        <div className="w-[40px] h-[40px] flex justify-center items-center">
          <CgSearch size={25}></CgSearch>
        </div>
        <h3 className="font-semibold leading-[-0.005%] text-[#F3F5F7]">
          Search
        </h3>
      </Link>
      ...
      <Link className="w-full flex items-center gap-2" href="/profile">
        <div className="w-[40px] h-[40px] flex justify-center items-center">
          <div className="w-[30px] relative  h-[30px]  rounded-full flex justify-center items-center">
            <Image
              fill
              src={
